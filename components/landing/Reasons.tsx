    ...
    <section className="space-y-28 px-1 pb-1">
      <AnimatedTitle>
        <h2 className="heading-section">
          ...
          <span className="before:-z-1 relative inline-block before:absolute before:-bottom-0 before:-right-[0.6em] before:size-[1.375em] before:rounded-full before:bg-primary-light/60">
            learning
          </span>
        </h2>
      </AnimatedTitle>
