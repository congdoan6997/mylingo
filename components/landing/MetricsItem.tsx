...
import { motion, useTransform, useScroll, useSpring, type MotionValue } from "framer-motion"
import { type PropsWithChildren, useRef } from "react"
import { AspectRatio } from "@/components/ui/aspect-ratio"
import AnimatedNumber, { AnimatedNumberProps } from "@/components/motion/AnimatedNumber"
...
export default function MetricsItem({
  ...
  return (
    <motion.div ref={ref} {...originTop} style={{ scale, opacity }}>
      <motion.div {...originTop} style={{ opacity: exitOpacity, scale: exitScale }}>
        <AspectRatio
          ratio={1}
          className={cn(
